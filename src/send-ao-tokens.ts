...
async function main() {
  ...
  const quantity = 1_000_000_000_000_000_000; // Has a denomination of 12, meaning 1 AO = 1,000,000,000,000,000,000 sub units of AO.
  const messageId = await message({
    process: "0syT13r0s0tgPmIed95bJnuSqaD29HQNN8D3ElLSrsc", // This is the AO Token Process ID
    signer: createDataItemSigner(wallet),
    tags: [
      { name: "Action", value: "Transfer" },
      { name: "Target", value: recipientWalletAddress },
